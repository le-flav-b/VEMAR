...
uint32_t idx = 0; // global index for json entries
uint8_t sd_valid = 0; // flag for SD card validity
uint8_t file_valid = 0; // flag for file validity
